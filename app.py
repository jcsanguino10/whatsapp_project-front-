...
def main():
    ...
    options= []
    while True:
        url_msg = "https://gate.whapi.cloud/messages/list/120363224308027086%40g.us?count=2&token=3vbynH98gs0Nycgm607SOAUEbFWq094O"
        ...
        if responder:
            url = "https://gate.whapi.cloud/messages/text?token=3vbynH98gs0Nycgm607SOAUEbFWq094O"
